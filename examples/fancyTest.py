...
async def main():
    ...
    # Show task
    task = "Read the file 'agent_docs.md' and then write a python script that would use 'examples/mcp_server.py' to 'generate two random numbers between 1-100, add them together and save the result in a file called result.txt' it's okay/expected if mcp_server.py is not accessible from the testing directory."
